    ...
    <Router>
      <Routes>
        ...
        <Route
          ...
          element={<ReservationDetails state={state} />}
        />
        ...
        />
        <Route
          path="dashboard/showtimes/create"
          element={
            <Private>
              <CreateShowTime />
            </Private>
        ...
        />
        <Route
          path="/rezervasyon/:showtime_id"
          element={
            <Private>
              <Rezervasyon setState={setState} />
            </Private>
          }
        />
        <Route
