      ...
      <div className="ticket-container">
        <div className="ticket">
          ...
          <div className="ticket-body">
            <div className="ticket-item m-2 shadow-lg hover:bg-gray-800 transition ease flex justify-around items-center border p-2 rounded-lg shadow-lg">
              <p className="ticket-label text-lg font-semibold p-1">Film Adı:</p>
              <p className="ticket-value ">{reservationDetails.movieTitle}</p>
            </div>
            <div className="ticket-item m-2 shadow-lg hover:bg-gray-800 transition ease flex justify-around items-center border p-2 rounded-lg shadow-lg text-center">
